            ...
            <Main>
                <ul className="flex flex-col">
                    <li className="mb-16">
                        ...
                        <h3 className="px-2 mt-2 bold text-center">New Year</h3>
                    </li>
                    ...
                    <li className="mb-16">
                        ...
                        <h3 className="px-2 mt-2 bold text-center">Covid</h3>
                    </li>
                    ...
                    <li>
                        ...
                        <h3 className="px-2 mt-2 bold text-center">Original</h3>
                    </li>
                </ul>
            </Main>
